...
public class TestControllerIntegrationTest {
  ...
  public void testPost() {
    ...
    this.webTestClient.post().uri("/hardcoded-tests").body(BodyInserters.fromMultipartData(multipartBodyBuilder.build())).header(HttpHeaders.CONTENT_TYPE, MediaType.MULTIPART_FORM_DATA_VALUE)
        .exchange().expectStatus().isOk().expectBody().json("{status:\"SomeData\"}");
  }
